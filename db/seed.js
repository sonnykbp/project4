...
var posts = [laptop, ipod, tv, android, couch, desk, dining, barstools, lotr, harrypotter, games, ps3, sweater, sweater2, shorts, shirt]
var categories = [electronics, furniture, digital_media, clothes]


categories.forEach((category, i) =>{
  category.posts.push(posts[i], posts[i+1], posts[i+2], posts[i+3])
})
